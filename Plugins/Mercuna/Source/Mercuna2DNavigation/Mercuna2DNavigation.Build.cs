...
public class Mercuna2DNavigation : ModuleRules
{
	public Mercuna2DNavigation(ReadOnlyTargetRules Target) : base(Target)
    {
        
		PrivateIncludePaths.AddRange(
			new string[] {
                "Mercuna2DNavigation/Private",
			}
			);
		...
		PrivatePCHHeaderFile = "Private/Mercuna2DNavigationPrivatePCH.h";
